...
const COMPLEXES: Complex[] = [
  {
    ...
    imgUrl: "/iremel.jpeg",
    fallbackUrl: "https://www.image2url.com/r2/default/images/1780892744345-85443077-c864-46fc-bdba-95b2185ff37d.jpg",
    prices: [
  ...
  },
  {
    ...
    developer: "Prime Development",
    imgUrl: "/prime.jpeg",
    fallbackUrl: "https://www.image2url.com/r2/default/images/1780892747938-a1193e63-6782-43fd-9acf-92ea16f1ebaa.jpg",
    prices: [
  ...
  },
  {
    ...
    developer: "СтройТЭК",
    imgUrl: "/aurus.jpeg",
    fallbackUrl: "https://www.image2url.com/r2/default/images/1780892750550-335e97e4-6c04-4a2e-9ec7-91411fe6ba68.jpg",
    prices: [
  ...
  },
  {
    ...
    developer: "ГК БРИГ",
    imgUrl: "/geos.jpeg",
    fallbackUrl: "https://www.image2url.com/r2/default/images/1780892753234-27830d66-407f-481f-9d8f-8b751d2beba1.jpg",
    prices: [
  ...
  },
  {
    ...
    imgUrl: "/terle.jpeg",
    fallbackUrl: "https://www.image2url.com/r2/default/images/1780892757100-f5b5caab-b1bf-4eee-859a-b4a8015f0680.jpg",
    prices: [
      { type: "Студия", price: "от 6,2 млн ₽" },
      { type: "1-комн", price: "от 7,5 млн ₽" },
...
// Safe image wrapper that handles local load errors and falls back to a remote URL automatically
...
export default function LandingPage() {
  ...
  const getMaxSlide = useCallback(() => {
    if (screenSize === 'mobile') return COMPLEXES.length - 1;
    if (screenSize === 'tablet') return COMPLEXES.length - 2;
    return COMPLEXES.length - 3;
  }, [screenSize]);
  ...
  useEffect(() => {
    ...
    return () => clearInterval(interval);
  }, [getMaxSlide, isCarouselHovered, selectedComplex]);
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12">
            ...
            >
              <motion.div 
                animate={{ 
                  x: screenSize === 'mobile'
                    ? `calc(-${activeSlide * 100}% - ${activeSlide * 16}px)`
                    : screenSize === 'tablet'
                    ? `calc(-${activeSlide * 50}% - ${activeSlide * 16}px)`
                    : `calc(-${activeSlide * 33.333}% - ${activeSlide * 24}px)`
                }}
                ...
                {COMPLEXES.map((item, index) => {
                  return (
                    <motion.div 
                      ...
                      className="relative bg-white border border-slate-200/60 rounded-2xl md:rounded-3xl shadow-sm hover:shadow-xl hover:border-slate-300 transition-all flex flex-col justify-between overflow-hidden p-4 select-none h-[410px] md:h-[440px] w-[calc(100%-8px)] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] flex-shrink-0 group cursor-pointer"
                    >
                      {/* Photo Area */}
              ...
              >
                ...
                <div className="h-[200px] w-full relative">
                  <SafeImage 
                    ...
                    fallbackSrc={selectedComplex.fallbackUrl}
        ...
        <section id="how" className="relative w-full lg:h-[350vh]">
          ...
          <div className="lg:sticky lg:top-0 lg:h-screen w-full flex items-center justify-center lg:overflow-hidden bg-gradient-to-b from-[#F8FAFC] via-[#F1F5F9]/85 to-[#F8FAFC] text-slate-900 border-y border-slate-200/50 md:rounded-3xl shadow-2xl min-h-screen lg:min-h-0 py-10 lg:py-0">
            ...
            >
              ...
              <source src="https://www.image2url.com/r2/default/videos/1780893793276-96a9b68c-e7b7-4d8d-93d7-0dbb02e445dd.mp4" type="video/mp4" />
            </video>
